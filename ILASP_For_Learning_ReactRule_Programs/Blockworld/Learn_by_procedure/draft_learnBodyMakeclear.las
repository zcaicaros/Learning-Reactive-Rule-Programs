...
% S_M
#modeh(ruleapp(var(time),var(block),const(priority),s)).
...
% This learning is successful because it gives hypothesis which is more optimal than the 
% original one. (which is ruleapp(V1,V2,3,s) :- make_clear_h(V0,V1), on(V2,V0,V1).)
